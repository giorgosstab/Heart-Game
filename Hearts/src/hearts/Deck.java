        ...
        for(int j = 0; j < 4; j++){
            for(int i = 2; i < 15; i++){
                if(i < 11){
                    ...
                    switch(i){
                        case 11: this.deck.add(new Card(this.symbol[j] , "J"));
                            break;
                        case 12: this.deck.add(new Card(this.symbol[j] , "Q"));
                            break;
                        case 13: this.deck.add(new Card(this.symbol[j] , "K"));
                            break;
                        case 14: this.deck.add(new Card(this.symbol[j] , "A"));   
                        default:
                            break;
                    }
                }
